...
class DataPrepper:
    ...
    def __log_ltr_query_features(self, query_id, key, query_doc_ids, click_prior_query, no_results, terms_field="_id"):
        ...
        for searchResult in hitList:
            features = {
                f["name"]: f.get("value", 0) for f in searchResult["fields"]["_ltrlog"][0]["features"]
            }
            features["doc_id"] = searchResult["_id"]
            features["sku"] = searchResult["_id"]
